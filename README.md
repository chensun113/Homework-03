# Homework-03
  ...
  At first, I started to connecting css and js files. Then,the onclick function of the button has been created writePassword(). I understand the "addEventListener" is the same as <button onclick="">, but I am not used to use it. Using Math.random() ,charAt,and Math.floor() to choose characters randomly. 
